...
BASEDIR=${1:-/cluster/work/users/ingo/archive/norcpm-cf-system1_hindcast20210621/norcpm-cf-system1_hindcast20210621_19921015}
COMPRESSION=${2:-deflateppcsafe} # one of "nocomp deflate deflateppc deflatepccsafe"   
MAXTHREAD=${3:-128}
...
#OPREFIX=${IPREFIX}_mem${MEMBER1}-${MEMBERN}_$COMPRESSION
