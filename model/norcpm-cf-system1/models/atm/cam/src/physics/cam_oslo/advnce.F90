...
#ifdef AERLIFE
! Test if new month and read in new data as needed 
  call emint
#endif

  ! Prescribed tracers
  call prescribed_ozone_adv(phys_state,pbuf)
  call prescribed_ghg_adv(phys_state,pbuf)
  call prescribed_aero_adv(phys_state,pbuf)
  call aircraft_emit_adv(phys_state,pbuf)
  call prescribed_volcaero_adv(phys_state,pbuf)
