...
#change log
# 20160318 (ingo.bethke@uni.no): use hard links for restart data

# do copying on backend of hexagon 
if [[ "$MACH" == "hexagon" || "$MACH" == "hexagon_intel" || "$MACH" == "hexagon_pgi" ]]; then
  CP='aprun -n 1 cp'
else
  CP=cp
fi
...
# 2015.07.15 ingo.bethke@uni.no: write directly to short-term archive location (do not create temporary directory)
sta=${DOUT_S_ROOT} 
...
set ${CASE}.cam?.r.*;        latest=`head -1 ${sta}/rest/${dname}/rpointer.atm`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
...
set ${CASE}.cam?.h0.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h0' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h1.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h1' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h2.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h2' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h3.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h3' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h4.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h4' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h5.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; latest=`grep -P '\.h5' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.hs.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; ln -f $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.i.*;        latest=`ls -rt $* 2> /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/init $*

set ${CASE}.clm?.r.*;        latest=`head -1 ${sta}/rest/${dname}/rpointer.lnd`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh0.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh1.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh2.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh3.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh4.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh5.*;      latest=`ls -rt $* 2>  /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
...
set ${CASE}.cice.r.[0-9]*;   latest=`head -1 ${sta}/rest/${dname}/rpointer.ice`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ice/rest $*
...
set ${CASE}.cpl.r.*;         latest=`head -1 ${sta}/rest/${dname}/rpointer.drv`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/cpl/rest $*
set ${CASE}.cpl.h* ;                                                                                                  dispose ifiles_n ${sta}/cpl/hist $*

set ${CASE}.micom.r.*;       latest=`head -1 ${sta}/rest/${dname}/rpointer.ocn`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ocn/rest $*
set ${CASE}.micom.rbgc.*;    latest=`ls -rt $* 2> /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ocn/rest $*
set ${CASE}.micom.hd*;       latest=`ls -rt $* 2> /dev/null | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/ocn/hist $*
set ${CASE}.micom.h*;                                                                                                 dispose ifiles_n ${sta}/ocn/hist $*
...
# copy rpointer files back to run directory; create hard links to data files 
for ITEM in `ls -1 ${sta}/rest/${dname}` 
do 
  if [ `echo $ITEM | grep rpointer` ] 
  then 
    cp ${sta}/rest/${dname}/$ITEM .
  else 
    ln ${sta}/rest/${dname}/$ITEM .
  fi  
done 
