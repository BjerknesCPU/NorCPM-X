#! /bin/csh -f 
#==============================================================================
# CCSM micom: build namelist
#==============================================================================

set exedir = $EXEROOT/run; cd $exedir
...
&LIMITS
  ...
  SMTFRC   = .true.,
  SPRFAC   = .false.,
  PATH     = "$DIN_LOC_ROOT/ocn/micom/gx1v6/20101119/",
  PATH1    = './',
  PATH2    = './',
  ATM_PATH = './',
  RSTFRQ   = 1,
...
! TS-NUDGING NAMELIST
&NUDGETS
  NUDGE_PATH  = "$DIN_LOC_ROOT/ocn/micom/gx1v6/20101119/phc3.0_monthly_s1.nc",
  NUDGE_TAU   = 1.,
  NUDGE_T   = .FALSE.,
  NUDGE_S   = .FALSE.
  NUDGE_NLIM  = 90.
