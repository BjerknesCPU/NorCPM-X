...
# experiment settings
: ${CASE_PREFIX:=dewPoint_test} # case prefix, not including _YYYYMMDD_XX suffix ; extracted from name of this file
: ${REST_PREFIX:=NorESM1-ME_historicalExt_noAssim_mem} 
: ${REST_PATH_REMOTE:=}
: ${REST_PATH_LOCAL:=/cluster/work/users/ingo/restarts/NorESM1-ME_historicalExt_noAssim}
