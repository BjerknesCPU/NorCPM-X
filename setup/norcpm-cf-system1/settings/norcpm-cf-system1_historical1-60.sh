...
# experiment settings
: ${CASE_PREFIX:=NorESM1-ME_historicalExt_noAssim} # case prefix, not including _YYYYMMDD_XX suffix ; extracted from name of this file
...
: ${STOP_N:=22} # run continuesly for this length 
